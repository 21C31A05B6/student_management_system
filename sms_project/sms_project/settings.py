...
if not DEBUG:
    ...
    if not SECRET_KEY or SECRET_KEY.startswith('django-insecure-') or SECRET_KEY.startswith('sms-dev-') or SECRET_KEY == 'sms-dev-secret-key-change-me-before-production-!@#2026':
